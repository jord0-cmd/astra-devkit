...
const MCP_CATALOG = [
  ...
  // GCP DATA \u2014 BigQuery + Cloud Storage
  {key: 'bigquery', name: 'BigQuery + GCS Toolbox', category: 'GCP', desc: 'BigQuery query tools (execute_sql, dataset/table inspection, forecast, ask_data_insights) + GCS object tools (read, write, list buckets, IAM) via @toolbox-sdk/server. 23 tools total.', requires: 'npx', setup: 'Run: gcloud auth application-default login. Set GOOGLE_CLOUD_PROJECT and GOOGLE_CLOUD_LOCATION env vars in your shell before launching gemini.', office: false, config: {command: 'npx', args: ['-y', '@toolbox-sdk/server', '--prebuilt', 'bigquery', '--prebuilt', 'cloud-storage', '--stdio'], env: {BIGQUERY_PROJECT: '$GOOGLE_CLOUD_PROJECT', BIGQUERY_LOCATION: '$GOOGLE_CLOUD_LOCATION', CLOUD_STORAGE_PROJECT: '$GOOGLE_CLOUD_PROJECT'}, timeout: 60000}},
  // DEVOPS
