...
const MCP_CATALOG = [
  ...
  {key: 'dbhub', name: 'DBHub', category: 'DATABASES', desc: 'Multi-DB: PostgreSQL, MySQL, MariaDB, SQL Server, SQLite (needs DSN connection string)', requires: 'npx', config: {command: 'npx', args: ['-y', '@bytebase/dbhub@latest', '--transport', 'stdio'], env: {DSN: 'postgres://user:password@localhost:5432/mydb'}, timeout: 30000}},
