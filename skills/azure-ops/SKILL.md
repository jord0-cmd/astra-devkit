---
name: azure-ops
description: Use this skill when working with Azure services — App Service, Azure Functions, Cosmos DB, Blob Storage, Storage Queues, Key Vault, Entra ID, Bicep IaC, Azure DevOps Pipelines, or any Azure deployment. Contains production patterns for secure Azure development with managed identities and infrastructure as code.
---

# Azure Ops

Azure services, infrastructure as code, secure deployment. Production patterns.
